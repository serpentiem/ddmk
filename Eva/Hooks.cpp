...
void Hooks_Init()
{
	...
	Write<DWORD>((appBaseAddr + 0x18754), DISCL_NONEXCLUSIVE | DISCL_FOREGROUND); // SetCooperativeLevelKeyboard
	{
		...
		FUNC func = CreateFunction(DirectInput8_Hook_GetDeviceStateKeyboard, (appBaseAddr + 0x156D3), false, true, sizeof(sect0), 0, sizeof(sect2));
		memcpy(func.sect0, sect0, sizeof(sect0));
		memcpy(func.sect2, sect2, sizeof(sect2));
		WriteJump((appBaseAddr + 0x156CB), func.addr);
	}
	{
		BYTE sect0[] =
		{
		...
		FUNC func = CreateFunction(DirectInput8_Hook_GetDeviceStateKeyboard, (appBaseAddr + 0x189E5), false, true, sizeof(sect0), 0, sizeof(sect2));
		memcpy(func.sect0, sect0, sizeof(sect0));
		memcpy(func.sect2, sect2, sizeof(sect2));
		WriteJump((appBaseAddr + 0x189DD), func.addr);
	}
	CreateThread(0, 4096, DirectInput8_CreateMouseThread, 0, 0, 0);
	{
		...
		FUNC func = CreateFunction(XInput_Hook_GetState, (appBaseAddr + 0x154CF), false, true, sizeof(sect0), 0, sizeof(sect2));
		memcpy(func.sect0, sect0, sizeof(sect0));
		WriteAddress((func.sect0 + 0xF), (appBaseAddr + 0x4073F8), 6);
		memcpy(func.sect2, sect2, sizeof(sect2));
		WriteJump((appBaseAddr + 0x154C9), func.addr, 1);
	}
}
