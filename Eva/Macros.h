...
// #define _IntroducePlayerActorData(name, ...)\
// auto name = *reinterpret_cast<byte8 **>(appBaseAddr + 0x60B148);\
// if (!name)\
// {\
// 	__VA_ARGS__;\
// }\
// auto & actorData = *reinterpret_cast<PlayerActorData *>(name)
// #define IntroducePlayerActorData(...) _IntroducePlayerActorData(Prep_Merge(pool_, __LINE__), __VA_ARGS__)
