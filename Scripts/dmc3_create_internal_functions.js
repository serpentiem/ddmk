...
[
	...
	[ 0x8A000 , "void"   , "byte8 * dest, byte8 * motionArchive, byte8 * addr"                                , ""                             ],
	[ 0x2C9F40, "uint32" , "byte8 * physicsFile"                                                              , "0, true, false"               ],
	[ 0x2CA1D0, "void"   , "byte8 * dest, byte8 * addr, byte8 * physicsFile, uint32 index"                    , ""                             ],
	[ 0x2CA2F0, "void"   , "byte8 * dest, byte8 * addr, byte8 * unknown, MODEL_DATA * modelData, uint32 count", "0, true, true, 0, 0, 0, 0, 1" ],
	...
	[ 0x1DE820, "byte8 *", "uint32 character, uint32 actor, bool isDoppelganger"                              , ""                             ],
	[ 0x217B90, "void"   , "byte8 * baseAddr, byte8 * sessionData"                                            , ""                             ],
	[ 0x223CB0, "void"   , "byte8 * baseAddr, byte8 * sessionData"                                            , ""                             ],
	[ 0x1DFC20, "void"   , "byte8 * baseAddr"                                                                 , ""                             ],
	[ 0x2310B0, "byte8 *", "byte8 * baseAddr, uint32 id"                                                      , ""                             ],
	[ 0x22EC90, "byte8 *", "byte8 * baseAddr, uint32 id"                                                      , ""                             ],
	[ 0x227870, "byte8 *", "byte8 * baseAddr, uint32 id"                                                      , ""                             ],
	[ 0x22A1E0, "byte8 *", "byte8 * baseAddr, uint32 id"                                                      , ""                             ],
	[ 0x228CF0, "byte8 *", "byte8 * baseAddr, uint32 id"                                                      , ""                             ],
	[ 0x22B0C0, "byte8 *", "byte8 * baseAddr, uint32 id"                                                      , ""                             ],
	[ 0x2306B0, "byte8 *", "byte8 * baseAddr, uint32 id"                                                      , ""                             ],
	[ 0x22C4A0, "byte8 *", "byte8 * baseAddr, uint32 id"                                                      , ""                             ],
	[ 0x2300A0, "byte8 *", "byte8 * baseAddr, uint32 id"                                                      , ""                             ],
	[ 0x22BA30, "byte8 *", "byte8 * baseAddr, uint32 id"                                                      , ""                             ],
	[ 0x22D960, "byte8 *", "byte8 * baseAddr, uint32 id"                                                      , ""                             ],
	[ 0x2298E0, "byte8 *", "byte8 * baseAddr, uint32 id"                                                      , ""                             ],
	[ 0x22CF00, "byte8 *", "byte8 * baseAddr, uint32 id"                                                      , ""                             ],
];
