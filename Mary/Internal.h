...
typedef void(__fastcall * func_217B90_t)(byte8 * actorData, byte8 * sessionData); // Init Actor Dante
typedef void(__fastcall * func_226F10_t)(byte8 * actorData, byte8 * sessionData); // Init Actor Bob
typedef void(__fastcall * func_219660_t)(byte8 * actorData, byte8 * sessionData); // Init Actor Lady
typedef void(__fastcall * func_223CB0_t)(byte8 * actorData, byte8 * sessionData); // Init Actor Vergil
...
typedef byte8 *(__fastcall * func_2310B0_t)(byte8 * actorData, uint32 id); // Dante Rebellion
typedef byte8 *(__fastcall * func_22EC90_t)(byte8 * actorData, uint32 id); // Dante Cerberus
typedef byte8 *(__fastcall * func_227870_t)(byte8 * actorData, uint32 id); // Dante Agni & Rudra
typedef byte8 *(__fastcall * func_22A1E0_t)(byte8 * actorData, uint32 id); // Dante Nevan
typedef byte8 *(__fastcall * func_228CF0_t)(byte8 * actorData, uint32 id); // Dante Vergil Beowulf
typedef byte8 *(__fastcall * func_22B0C0_t)(byte8 * actorData, uint32 id); // Dante Ebony & Ivory
typedef byte8 *(__fastcall * func_2306B0_t)(byte8 * actorData, uint32 id); // Dante Shotgun
typedef byte8 *(__fastcall * func_22C4A0_t)(byte8 * actorData, uint32 id); // Dante Artemis
typedef byte8 *(__fastcall * func_2300A0_t)(byte8 * actorData, uint32 id); // Dante Spiral
typedef byte8 *(__fastcall * func_22BA30_t)(byte8 * actorData, uint32 id); // Dante Lady Kalina Ann
typedef byte8 *(__fastcall * func_231A30_t)(byte8 * actorData, uint32 id); // Bob Yamato
typedef byte8 *(__fastcall * func_22D960_t)(byte8 * actorData, uint32 id); // Vergil Yamato
typedef byte8 *(__fastcall * func_2298E0_t)(byte8 * actorData, uint32 id); // Vergil Force Edge
typedef byte8 *(__fastcall * func_22CF00_t)(byte8 * actorData, uint32 id); // Vergil Nero Angelo Sword
...
typedef void(__fastcall * func_1EFB90_t)(byte8 * actorData, uint32 group, uint32 index, float32, int8, uint8, uint8); // Play motion and update state.
...
typedef void(__fastcall * func_32BA90_t)(byte8 * dest, const char * filename, uint32, uint32); // Set Track
...
extern func_32BE20_t func_32BE20;
extern func_32BA90_t func_32BA90;
