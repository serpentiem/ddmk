...
typedef void(__fastcall * func_280160_t)(byte8 *, uint32, uint32, uint32); // Weapon Switch Animation Vergil
typedef void(__fastcall * func_1EB0E0_t)(ACTOR_DATA & actorData, uint32 index); // Call after Weapon Switch Animation.
typedef void(__fastcall * func_1F92C0_t)(ACTOR_DATA & actorData, uint32 index); // Queue devil model update.
