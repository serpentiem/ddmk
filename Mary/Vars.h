...
enum MODEL_HELPER_PART_
{
	MODEL_HELPER_PART_BASE,
	MODEL_HELPER_PART_COAT,
	MODEL_HELPER_MAX_PART,
};

enum DEVIL_MODEL_HELPER_PART_
{
	DEVIL_MODEL_HELPER_PART_BASE,
	DEVIL_MODEL_HELPER_PART_COAT,
	DEVIL_MODEL_HELPER_PART_WINGS,
	DEVIL_MODEL_HELPER_MAX_PART,
};

struct MODEL_HELPER_FILE_HELPER
{
	struct Data
	{
		uint16 cacheFileId;
