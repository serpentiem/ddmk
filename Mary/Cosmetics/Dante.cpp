...
void Cosmetics_Dante_Init()
{
	LogFunction();
	{
		BYTE sect1[] =
		{
			...
			0xE8, 0x00, 0x00, 0x00, 0x00,             //call dmcLauncher.exe+89DE0
			0x48, 0x8B, 0xC8,                         //mov rcx,rax
			0xBA, 0x03, 0x00, 0x00, 0x00,             //mov edx,00000003
			0xE8, 0x00, 0x00, 0x00, 0x00,             //call dmcLauncher.exe+2F74E0
			0x48, 0x8D, 0x8E, 0x00, 0x02, 0x00, 0x00, //lea rcx,[rsi+00000200]
			0xE8, 0x00, 0x00, 0x00, 0x00,             //call dmcLauncher.exe+89DE0
			0x48, 0x8B, 0xC8,                         //mov rcx,rax
			0xBA, 0x04, 0x00, 0x00, 0x00,             //mov edx,00000004
			0xE8, 0x00, 0x00, 0x00, 0x00,             //call dmcLauncher.exe+2F7350
			0x48, 0x8D, 0x8E, 0x00, 0x02, 0x00, 0x00, //lea rcx,[rsi+00000200]
			0xE8, 0x00, 0x00, 0x00, 0x00,             //call dmcLauncher.exe+89DE0
			0x48, 0x8B, 0xC8,                         //mov rcx,rax
