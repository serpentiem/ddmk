...
void UpdateModelTemplate(byte8 * baseAddr)
{
...

	{
		...
		(
			dest,
			File_staticFiles[fileHelper.model.cacheFileId][fileHelper.model.fileIndex],
			File_staticFiles[fileHelper.texture.cacheFileId][fileHelper.texture.fileIndex]
		);
		...
		(
			...
			File_staticFiles[fileHelper.shadow.cacheFileId][fileHelper.shadow.fileIndex]
		);
	...
	)
	{
		...
		(
			dest,
			dest2,
			File_staticFiles[fileHelper.physics.cacheFileId][fileHelper.physics.fileIndex]
		);
