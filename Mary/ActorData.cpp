...
static_assert(offsetof(ACTOR_DATA, airStingerCount) == 0xB96F);
...
static_assert(offsetof(ACTOR_DATA_DANTE, airStingerCount) == 0xB96F);
...
static_assert(offsetof(ACTOR_DATA_BOB, airStingerCount) == 0xB96F);
...
static_assert(offsetof(ACTOR_DATA_LADY, airStingerCount) == 0xB96F);
...
static_assert(offsetof(ACTOR_DATA_VERGIL, airStingerCount) == 0xB96F);
