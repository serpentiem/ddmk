...
static_assert(offsetof(ACTOR_DATA, attackData) == 0xD8);
...
static_assert(offsetof(ACTOR_DATA_DANTE, attackData) == 0xD8);
...
static_assert(offsetof(ACTOR_DATA_BOB, attackData) == 0xD8);
...
static_assert(offsetof(ACTOR_DATA_LADY, attackData) == 0xD8);
...
static_assert(offsetof(ACTOR_DATA_VERGIL, attackData) == 0xD8);
