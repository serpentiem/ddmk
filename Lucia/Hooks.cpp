...
)
{
	...
	if (Config.System.vSync != 0)
	{
		syncInterval = (Config.System.vSync - 1);
	}
...
void Hooks_Init()
{
	...
	/*
	dmc2.exe+41CA6 - 41 B8 01000000        - mov r8d,00000001 { 1 }
	...
	*/
	...
	Write<DWORD>((appBaseAddr + 0x41CA8), DISCL_NONEXCLUSIVE | DISCL_FOREGROUND); // SetCooperativeLevelKeyboard
	...
	//Write<DWORD>((appBaseAddr + 0x41CA8), DISCL_NONEXCLUSIVE || DISCL_FOREGROUND); // SetCooperativeLevelKeyboard
	{
		...
		FUNC func = CreateFunction(DirectInput8_Hook_GetDeviceStateKeyboard, (appBaseAddr + 0x3F9A3), false, true, sizeof(sect0), 0, sizeof(sect2));
		memcpy(func.sect0, sect0, sizeof(sect0));
		memcpy(func.sect2, sect2, sizeof(sect2));
		WriteJump((appBaseAddr + 0x3F99B), func.addr);
	}
	{
		BYTE sect0[] =
		{
		...
		FUNC func = CreateFunction(DirectInput8_Hook_GetDeviceStateKeyboard, (appBaseAddr + 0x42155), false, true, sizeof(sect0), 0, sizeof(sect2));
		memcpy(func.sect0, sect0, sizeof(sect0));
		memcpy(func.sect2, sect2, sizeof(sect2));
		WriteJump((appBaseAddr + 0x4214D), func.addr);
	}
	CreateThread(0, 4096, DirectInput8_CreateMouseThread, 0, 0, 0);
	{
		...
		FUNC func = CreateFunction(XInput_Hook_GetState, (appBaseAddr + 0x3102A), false, true, sizeof(sect0), 0, sizeof(sect2));
		memcpy(func.sect0, sect0, sizeof(sect0));
		WriteCall((func.sect0 + 0xF), (appBaseAddr + 0x2F2EB0));
		memcpy(func.sect2, sect2, sizeof(sect2));
		WriteJump((appBaseAddr + 0x31025), func.addr);
	}
}
