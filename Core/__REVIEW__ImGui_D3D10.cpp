// Modified from
// https://github.com/ocornut/imgui/blob/e0cab5664adf02c030f9cf2a05d2c334638a85f8/examples/imgui_impl_dx10.cpp

#include "ImGui_D3D10.h"
...
static void ImGui_D3D10_CreateFontsTexture()
{
    // Build texture atlas
...
bool ImGui_D3D10_CreateDeviceObjects()
{
    if (!g_pd3dDevice)
        return false;
    if (g_pFontSampler)
        ImGui_D3D10_InvalidateDeviceObjects();
    ...
    ImGui_D3D10_CreateFontsTexture();
...
{
    if (!g_pFontSampler)
        ImGui_D3D10_CreateDeviceObjects();
}
