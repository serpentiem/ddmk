...
static_assert(sizeof(DXGI_MODE_SCANLINE_ORDER) == 4);
...
static_assert(sizeof(DXGI_MODE_SCALING) == 4);
...
static_assert(sizeof(DXGI_MODE_ROTATION) == 4);
...
static_assert(sizeof(DXGI_SWAP_EFFECT) == 4);
...
static_assert(sizeof(DXGI_RESIDENCY) == 4);
